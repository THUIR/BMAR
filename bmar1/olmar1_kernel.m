function [weight, losses] = olmar1_kernel(data, weight_o, epsilon, W, losses)
%function [weight, expertloss, predictloss] = olmar1_kernel(data, weight_o, epsilon, W)
...
[weight, losses] = olmar1_expert_meta(data, weight_o, epsilon, W, losses);
